...
import React, { useState } from 'react';
    ...
    import signup from "../../assets/login3.jpg"
...
export default function SignUp() {
      ...
      return (
        <div className="min-h-screen flex flex-col lg:flex-row mt-10 lg:mt-0">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-6 ">
            <div className="max-w-md w-full space-y-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600">Sign up to start your Mock Test journey</p>
              </div>
          ...
          <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0158E7] via-[#0158E7] to-[#0158E7] relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
              <div className="max-w-md text-center">
                <img src={signup} alt="Sign Up Illustration" className="w-[130%] max-w-[500px] ml-18 h-auto mx-auto object-contain" />
              </div>
            </div>
            {/* Decorative Elements */}
